<?php
/*
Agora com a query bem organizada, voltamos a ter  resultado esperado. Mas vamos acrescentar na query uma cláusula WHERE. Ela vai indicar que só queremos os produtos cujo ID seja superior a 100. Não existe nenhum produto nessa situação. Então vamos ter o retorno de $resultados = [] já que não existem produtos na coleção com essa caracteristica.
*/
